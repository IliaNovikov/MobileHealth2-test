    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!etName.getText().equals(null) && !etHeight.getText().equals("") && !etHeight.getText().equals("0")
                && !etWeight.getText().equals("") && !etWeight.getText().equals("0") && !etDateBirth.getText().equals("")) {
